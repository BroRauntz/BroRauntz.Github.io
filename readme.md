...
<body>
    <div id="firstScreen" class="screen">
        ...
        <img src="tsau.gif" alt="Armas pilt" width="250" style="max-width: 90%;"> <!-- Lae see fail GitHubi -->
        <br>
    ...
    <div id="secondScreen" class="screen">
        ...
        <img src="aww.gif" alt="Armastus" width="250" style="max-width: 90%;"> <!-- Lae see fail GitHubi -->
    </div>
